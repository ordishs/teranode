...
func NewSettings(alternativeContext ...string) *Settings {
	...
	return &Settings{
		...
		UtxoStore: UtxoStoreSettings{
			...
			PackedSQLPartitions:                     getInt("utxostore_packedsql_partitions", 64, alternativeContext...),
			PackedSQLPageSize:                       getInt("utxostore_packedsql_pageSize", 64, alternativeContext...),
			PackedSQLSpendWorkers:                   getInt("utxostore_packedsql_spendWorkers", 8, alternativeContext...),
