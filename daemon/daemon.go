...
func printUsage() {
	...
	fmt.Println("")
	fmt.Println("    -help=1")
	fmt.Println("          print this usage information and exit")
	fmt.Println("")
	...
	fmt.Println("")
	fmt.Println("    -wait_for_postgres=1")
	fmt.Println("          wait for PostgreSQL to be ready before starting any service")
	fmt.Println("")
	fmt.Println("    -all=0")
