...
type RecordCatchupFailureRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PeerId        string                 `protobuf:"bytes,1,opt,name=peer_id,json=peerId,proto3" json:"peer_id,omitempty"`
	FailureKind   string                 `protobuf:"bytes,2,opt,name=failure_kind,json=failureKind,proto3" json:"failure_kind,omitempty"`
...
func (x *RecordCatchupFailureRequest) GetFailureKind() string {
	if x != nil {
...
func (x *RecordCatchupFailureRequest) GetBlockHash() string {
	if x != nil {
		return x.BlockHash
	}
	return ""
...
func (x *ReportValidatedChainProgressRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReportValidatedChainProgressRequest) GetHeight() uint32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *ReportValidatedChainProgressRequest) GetBlockHash() string {
	if x != nil {
		return x.BlockHash
	}
	return ""
...
func (x *ReportValidatedChainProgressRequest) GetChainWork() []byte {
	if x != nil {
		return x.ChainWork
	}
	return nil
...
type ReportValidatedChainProgressResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *ReportValidatedChainProgressResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ReportValidatedChainProgressResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
const file_services_p2p_p2p_api_p2p_api_proto_rawDesc = "" +
	...
	"\ffailure_kind\x18\x02 \x01(\tR\vfailureKind\x12\x1d\n" +
	"\n" +
	"block_hash\x18\x03 \x01(\tR\tblockHash\".\n" +
	...
	"\x06height\x18\x02 \x01(\rR\x06height\x12\x1d\n" +
	"\n" +
	"block_hash\x18\x03 \x01(\tR\tblockHash\x12\x1d\n" +
	"\n" +
	"chain_work\x18\x04 \x01(\fR\tchainWork\"Z\n" +
	"$ReportValidatedChainProgressResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	...
	"\x16RecordCatchupMalicious\x12&.p2p_api.RecordCatchupMaliciousRequest\x1a'.p2p_api.RecordCatchupMaliciousResponse\"\x00\x12_\n" +
...
var file_services_p2p_p2p_api_p2p_api_proto_goTypes = []any{
	...
	(*UpdateCatchupErrorRequest)(nil),            // 24: p2p_api.UpdateCatchupErrorRequest
	(*UpdateCatchupErrorResponse)(nil),           // 25: p2p_api.UpdateCatchupErrorResponse
	(*ResetReputationRequest)(nil),               // 26: p2p_api.ResetReputationRequest
	(*ResetReputationResponse)(nil),              // 27: p2p_api.ResetReputationResponse
	...
	(*ReportValidBlockHeadersRequest)(nil),       // 35: p2p_api.ReportValidBlockHeadersRequest
	(*ReportValidBlockHeadersResponse)(nil),      // 36: p2p_api.ReportValidBlockHeadersResponse
...
var file_services_p2p_p2p_api_p2p_api_proto_depIdxs = []int32{
	...
	24, // 17: p2p_api.PeerService.UpdateCatchupError:input_type -> p2p_api.UpdateCatchupErrorRequest
	26, // 18: p2p_api.PeerService.ResetReputation:input_type -> p2p_api.ResetReputationRequest
	28, // 19: p2p_api.PeerService.GetPeersForCatchup:input_type -> p2p_api.GetPeersForCatchupRequest
	31, // 20: p2p_api.PeerService.ReportValidSubtree:input_type -> p2p_api.ReportValidSubtreeRequest
	33, // 21: p2p_api.PeerService.ReportValidBlock:input_type -> p2p_api.ReportValidBlockRequest
	35, // 22: p2p_api.PeerService.ReportValidBlockHeaders:input_type -> p2p_api.ReportValidBlockHeadersRequest
	...
	25, // 42: p2p_api.PeerService.UpdateCatchupError:output_type -> p2p_api.UpdateCatchupErrorResponse
	27, // 43: p2p_api.PeerService.ResetReputation:output_type -> p2p_api.ResetReputationResponse
	30, // 44: p2p_api.PeerService.GetPeersForCatchup:output_type -> p2p_api.GetPeersForCatchupResponse
	32, // 45: p2p_api.PeerService.ReportValidSubtree:output_type -> p2p_api.ReportValidSubtreeResponse
	34, // 46: p2p_api.PeerService.ReportValidBlock:output_type -> p2p_api.ReportValidBlockResponse
	36, // 47: p2p_api.PeerService.ReportValidBlockHeaders:output_type -> p2p_api.ReportValidBlockHeadersResponse
