...
// GetPendingBlocksCountResponse contains the count of pending blocks.
type GetPendingBlocksCountResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Count         int32                  `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"` // Number of blocks with mined_set=false
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetPendingBlocksCountResponse) Reset() {
	*x = GetPendingBlocksCountResponse{}
	mi := &file_services_blockchain_blockchain_api_blockchain_api_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPendingBlocksCountResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPendingBlocksCountResponse) ProtoMessage() {}

func (x *GetPendingBlocksCountResponse) ProtoReflect() protoreflect.Message {
	mi := &file_services_blockchain_blockchain_api_blockchain_api_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPendingBlocksCountResponse.ProtoReflect.Descriptor instead.
func (*GetPendingBlocksCountResponse) Descriptor() ([]byte, []int) {
	return file_services_blockchain_blockchain_api_blockchain_api_proto_rawDescGZIP(), []int{61}
}

func (x *GetPendingBlocksCountResponse) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_services_blockchain_blockchain_api_blockchain_api_proto_rawDesc = "" +
	...
	"blockBytes\"5\n" +
	"\x1dGetPendingBlocksCountResponse\x12\x14\n" +
	...
	"\x15GetPendingBlocksCount\x12\x16.google.protobuf.Empty\x1a-.blockchain_api.GetPendingBlocksCountResponse\"\x00\x12[\n" +
...
var file_services_blockchain_blockchain_api_blockchain_api_proto_goTypes = []any{
	...
	(*GetPendingBlocksCountResponse)(nil),               // 63: blockchain_api.GetPendingBlocksCountResponse
...
var file_services_blockchain_blockchain_api_blockchain_api_proto_depIdxs = []int32{
	...
	104, // 55: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:input_type -> google.protobuf.Empty
	104, // 56: blockchain_api.BlockchainAPI.GetPendingBlocksCount:input_type -> google.protobuf.Empty
	...
	49,  // 92: blockchain_api.BlockchainAPI.GetLastNBlocks:output_type -> blockchain_api.GetLastNBlocksResponse
	51,  // 93: blockchain_api.BlockchainAPI.GetLastNInvalidBlocks:output_type -> blockchain_api.GetLastNInvalidBlocksResponse
	53,  // 94: blockchain_api.BlockchainAPI.GetSuitableBlock:output_type -> blockchain_api.GetSuitableBlockResponse
	57,  // 95: blockchain_api.BlockchainAPI.GetHashOfAncestorBlock:output_type -> blockchain_api.GetHashOfAncestorBlockResponse
	...
	59,  // 98: blockchain_api.BlockchainAPI.GetNextWorkRequired:output_type -> blockchain_api.GetNextWorkRequiredResponse
	...
	44,  // 118: blockchain_api.BlockchainAPI.GetState:output_type -> blockchain_api.StateResponse
	104, // 119: blockchain_api.BlockchainAPI.SetState:output_type -> google.protobuf.Empty
	47,  // 120: blockchain_api.BlockchainAPI.GetBlockIsMined:output_type -> blockchain_api.GetBlockIsMinedResponse
	104, // 121: blockchain_api.BlockchainAPI.SetBlockMinedSet:output_type -> google.protobuf.Empty
	104, // 122: blockchain_api.BlockchainAPI.ClearBlockMinedSet:output_type -> google.protobuf.Empty
	62,  // 123: blockchain_api.BlockchainAPI.GetBlocksMinedNotSet:output_type -> blockchain_api.GetBlocksMinedNotSetResponse
	63,  // 124: blockchain_api.BlockchainAPI.GetPendingBlocksCount:output_type -> blockchain_api.GetPendingBlocksCountResponse
