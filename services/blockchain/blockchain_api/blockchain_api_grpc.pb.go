...
type PeerRegistryServiceClient interface {
	...
	RecordValidatedPeerProgress(ctx context.Context, in *RecordValidatedPeerProgressRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *peerRegistryServiceClient) RecordValidatedPeerProgress(ctx context.Context, in *RecordValidatedPeerProgressRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, PeerRegistryService_RecordValidatedPeerProgress_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PeerRegistryServiceServer interface {
	...
	// RecordValidatedPeerProgress stores locally validated peer chain progress.
	RecordValidatedPeerProgress(context.Context, *RecordValidatedPeerProgressRequest) (*emptypb.Empty, error)
...
func (UnimplementedPeerRegistryServiceServer) RecordValidatedPeerProgress(context.Context, *RecordValidatedPeerProgressRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method RecordValidatedPeerProgress not implemented")
}
...
func _PeerRegistryService_RecordValidatedPeerProgress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RecordValidatedPeerProgressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PeerRegistryServiceServer).RecordValidatedPeerProgress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PeerRegistryService_RecordValidatedPeerProgress_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PeerRegistryServiceServer).RecordValidatedPeerProgress(ctx, req.(*RecordValidatedPeerProgressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PeerRegistryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RecordValidatedPeerProgress",
			Handler:    _PeerRegistryService_RecordValidatedPeerProgress_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "services/blockchain/blockchain_api/blockchain_api.proto",
