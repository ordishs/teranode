...
const (
	...
	BlockchainAPI_GetPendingBlocksCount_FullMethodName                = "/blockchain_api.BlockchainAPI/GetPendingBlocksCount"
...
type BlockchainAPIClient interface {
	...
	GetPendingBlocksCount(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetPendingBlocksCountResponse, error)
...
func (c *blockchainAPIClient) GetPendingBlocksCount(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetPendingBlocksCountResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPendingBlocksCountResponse)
	err := c.cc.Invoke(ctx, BlockchainAPI_GetPendingBlocksCount_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlockchainAPIServer interface {
	...
	// GetPendingBlocksCount returns the count of blocks not marked as mined,
	// regardless of subtrees_set status. Used by WaitForPendingBlocks.
	GetPendingBlocksCount(context.Context, *emptypb.Empty) (*GetPendingBlocksCountResponse, error)
	// SetBlockSubtreesSet marks a block's subtrees as set.
...
func (UnimplementedBlockchainAPIServer) GetPendingBlocksCount(context.Context, *emptypb.Empty) (*GetPendingBlocksCountResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetPendingBlocksCount not implemented")
}
...
func _BlockchainAPI_GetPendingBlocksCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlockchainAPIServer).GetPendingBlocksCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlockchainAPI_GetPendingBlocksCount_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlockchainAPIServer).GetPendingBlocksCount(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BlockchainAPI_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPendingBlocksCount",
			Handler:    _BlockchainAPI_GetPendingBlocksCount_Handler,
		},
		{
